...
class Test(unittest.TestCase):
    ...
    def test_encode_decode_int(self):
        self.assertEqual(actions.decode(actions._encode(1)), 1,
                         "Encode-decode of integer should be a nop.")

    def test_encode_decode_string(self):
        self.assertEqual(actions.decode(actions._encode("Hello")), "Hello",
                         "Encode-decode of string should be a nop.")

    def test_encode_decode_dict(self):
        test_dict = {"event": "addpoint",
                     "data": ['{"X":4,"Y":5,"chartID":"chart1"}']}
        self.assertEqual(actions.decode(actions._encode(test_dict)), test_dict,
                         "Encode-decode of dict should be a nop.")

    def test_add_point(self):
        self.assertEqual(actions.decode(actions.add_point("chart1", 4, 5)),
                         {"event": "addpoint",
                          "data": ['{"X":4,"Y":5,"chartID":"chart1"}']},
                         "Message should exactly be like second arg.")

    def test_add_point_wrong_chartid(self):
        self.assertEqual(actions.decode(actions.add_point(1, 2, 3)),
                         {"event": "message",
    ...
    def test_add_point_empty_chartid(self):
        self.assertEqual(actions.decode(actions.add_point("", 2, 3)),
                         {"event": "message",
                          "data": ['{"messageText":"Python function add_point '
    ...
    def test_add_point_wrong_x_coord_str(self):
        self.assertEqual(actions.decode(actions.add_point("one", "two", 12.0)),
                         {"event": "message",
                          "data": ['{"messageText":"Python function add_point '
    ...
    def test_add_point_wrong_x_coord_bool(self):
        self.assertEqual(actions.decode(actions.add_point("one", True, 12.0)),
                         {"event": "message",
                          "data": ['{"messageText":"Python function add_point '
                          'called with wrong x_coord type."}']},
    ...
    def test_add_point_wrong_y_coord_str(self):
        self.assertEqual(actions.decode(actions.add_point("one", 2, "three")),
                         {"event": "message",
                          "data": ['{"messageText":"Python function add_point '
    ...
    def test_add_point_wrong_y_coord_bool(self):
        self.assertEqual(actions.decode(actions.add_point("one", 2, False)),
                         {"event": "message",
                          "data": ['{"messageText":"Python function add_point '
                          'called with wrong y_coord type."}']},
                         "Message should exactly be like second arg (bool).")
    ...
    def test_message(self):
        self.assertEqual(actions.decode(actions.message("This is a message.")),
                         {"event": "message",
                          "data": ['{"messageText":"This is a message."}']},
                         "Message should be exactly like second arg.")

    def test_create_alert_gadget(self):
        self.assertEqual(actions.decode(actions.create_alert_gadget("cell0",
                                                "alertgadget", "My alerts")),
                         {"event": "createAlertGadget",
                          "data": ['{"cell":"cell0","id":"alertgadget","title":"My alerts"}']},
                         "Message should be exactly like second arg.")

    def test_alert(self):
        self.assertEqual(actions.decode(actions.alert("This is an alert.",
                                                      "alertgadget")),
                         {"event": "alert",
    ...
    def test_create_general_chart(self):
        ...
        self.assertEqual(actions.decode(actions.create_general_chart("cell1",
                                        "chart1", "My chart", chart_options)),
                         {"event": "createChart",
    ...
    def test_create_maps_gadget(self):
        ...
        self.assertEqual(actions.decode(actions.create_maps_gadget("cell0",
                                            "myMap", "aTitle", map_options)),
    ...
    def test_add_maps_marker(self):
        self.assertEqual(actions.decode(actions.add_maps_marker("myMap", 31.3,
                                                                52.4, "NL")),
                         {"event": "addMapsMarker",
    ...
    def test_create_tweetlist_gadget(self):
        self.assertEqual(actions.decode(actions.create_tweetlist_gadget("cell0",
                                                "myMap", "Interesting tweets")),
    ...
    def test_add_tweetlist_tweet(self):
        tweet_data = {"user": {"name": "Pascal"},
                      "text": "This is my tweet"}
        self.assertEqual(actions.decode(actions.add_tweetlist_tweet(
                                                    "myTweetlist", tweet_data)),
                         {"event": "addTweet",
